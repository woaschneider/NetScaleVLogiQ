...
{
    /// <summary>
    /// MMWPFBusinessEditFrm1 Class
    /// </summary>
    public partial class MMWPFBusinessEditFrm1 : mmBusinessWindow
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public MMWPFBusinessEditFrm1()
        {
        ...
        public MMWPFBusinessEditFrm1(string title, int PK, bool New)
        {
            this.InitializeComponent();
            this.Title = title;
            CloseButtonHide = true;
