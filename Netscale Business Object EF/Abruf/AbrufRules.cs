...
{
	/// <summary>
	/// Summary description for AbrufRules.
	/// </summary>
	public partial class AbrufRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public AbrufRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Abruf)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						AbrufEntity Entity = CurrentEntity as AbrufEntity;
