...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class Abruf : ABusinessObject<AbrufEntity>
	{
		...
		{
			get { return (AbrufRules)this.BusinessRuleObj; }
		...
		public Abruf()
		{
			...
			this.TableName = "Abruf";
			this.PhysicalDbcObjectName = "dbo.Abruf";
			this.PrimaryKey = "PK";
		...
		protected override void HookSetDefaultValues(AbrufEntity entity)
		{
