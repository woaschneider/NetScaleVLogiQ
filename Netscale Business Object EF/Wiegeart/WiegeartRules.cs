...
namespace HWB.NETSCALE.BOEF
{
    ...
    /// </summary>
    public partial class WiegeartRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public WiegeartRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((Wiegeart) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        WiegeartEntity Entity = CurrentEntity as WiegeartEntity;
