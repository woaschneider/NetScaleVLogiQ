...
{
    /// <summary>
    /// Summary description for IncotermRules.
    /// </summary>
    public partial class IncotermRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public IncotermRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((Incoterm) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        IncotermEntity Entity = CurrentEntity as IncotermEntity;
