...
{
    /// <summary>
    /// Summary description for SvMandantRules.
    /// </summary>
    public partial class SvMandantRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public SvMandantRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((SvMandant) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        SvMandantEntity Entity = CurrentEntity as SvMandantEntity;
