...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class WarenartenRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public WarenartenRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Warenarten)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						WarenartenEntity Entity = CurrentEntity as WarenartenEntity;
