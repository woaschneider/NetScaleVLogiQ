...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class ArbeitsleistungsfilterRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ArbeitsleistungsfilterRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Arbeitsleistungsfilter)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						ArbeitsleistungsfilterEntity Entity = CurrentEntity as ArbeitsleistungsfilterEntity;
