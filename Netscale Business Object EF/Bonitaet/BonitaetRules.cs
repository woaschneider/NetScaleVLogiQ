...
{
    /// <summary>
    /// Summary description for BonitaetRules.
    /// </summary>
    public partial class BonitaetRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public BonitaetRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((Bonitaet) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        BonitaetEntity Entity = CurrentEntity as BonitaetEntity;
