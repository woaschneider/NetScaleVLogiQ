...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class WaegeRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public WaegeRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Waege)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						WaegeEntity Entity = CurrentEntity as WaegeEntity;
