...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class KKRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public KKRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((KK)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						KKEntity Entity = CurrentEntity as KKEntity;
