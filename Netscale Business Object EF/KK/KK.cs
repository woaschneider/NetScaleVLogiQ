...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class KK : ABusinessObject<KKEntity>
	{
		...
		/// </summary>
		public virtual KKRules Rules
		{
			get { return (KKRules)this.BusinessRuleObj; }
		...
		public KK()
		{
			...
			this.TableName = "KK";
			this.PhysicalDbcObjectName = "dbo.KK";
			this.PrimaryKey = "pk";
