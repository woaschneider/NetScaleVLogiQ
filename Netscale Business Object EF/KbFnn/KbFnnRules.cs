...
{
    /// <summary>
    /// Summary description for KbFnnRules.
    /// </summary>
    public partial class KbFnnRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public KbFnnRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((KbFnn) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        KbFnnEntity Entity = CurrentEntity as KbFnnEntity;
