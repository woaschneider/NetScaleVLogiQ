...
namespace HWB.NETSCALE.BOEF
{
    ...
    /// </summary>
    public partial class UserRollenRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public UserRollenRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((UserRollen) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        UserRollenEntity Entity = CurrentEntity as UserRollenEntity;
