...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class KMRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public KMRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((KM)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						KMEntity Entity = CurrentEntity as KMEntity;
