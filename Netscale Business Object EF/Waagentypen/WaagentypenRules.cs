...
namespace HWB.NETSCALE.BOEF
{
    ...
    /// </summary>
    public partial class WaagentypenRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public WaagentypenRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((Waagentypen) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        WaagentypenEntity Entity = CurrentEntity as WaagentypenEntity;
