...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class Fahrzeuge : ABusinessObject<FahrzeugeEntity>
	{
		...
		{
			get { return (FahrzeugeRules)this.BusinessRuleObj; }
		...
		public Fahrzeuge()
		{
			...
			this.PhysicalDbcObjectName = "dbo.Fahrzeuge";
			this.PrimaryKey = "PK";
		...
		{
			return new FahrzeugeRules(this);
		}
