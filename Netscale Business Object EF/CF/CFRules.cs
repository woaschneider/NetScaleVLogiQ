...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class CFRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public CFRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((CF)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						CFEntity Entity = CurrentEntity as CFEntity;
