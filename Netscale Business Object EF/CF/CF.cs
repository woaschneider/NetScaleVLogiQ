...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class CF : ABusinessObject<CFEntity>
	{
		...
		/// </summary>
		public virtual CFRules Rules
		{
			get { return (CFRules)this.BusinessRuleObj; }
		...
		public CF()
		{
			...
			this.TableName = "CF";
			this.PhysicalDbcObjectName = "dbo.CF";
			this.PrimaryKey = "PK";
