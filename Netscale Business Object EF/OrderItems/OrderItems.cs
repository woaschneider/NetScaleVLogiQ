...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class OrderItems : ABusinessObject<OrderItemsEntity>
	{
		...
		/// </summary>
		public override OrderItemsEntity Entity
		{
			get
			{
		...
		private OrderItemsEntity _entity;

		/// <summary>
		/// Business Rule object
		/// </summary>
		public virtual OrderItemsRules Rules
		{
			get { return (OrderItemsRules)this.BusinessRuleObj; }
		...
		public OrderItems()
		{
			...
			this.PhysicalDbcObjectName = "dbo.orderItems";
			this.PrimaryKey = "PK";
		...
		{
			return new OrderItemsRules(this);
		}
