...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class OrderItemsRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public OrderItemsRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((OrderItems)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						OrderItemsEntity Entity = CurrentEntity as OrderItemsEntity;
