...
{
    /// <summary>
    /// Summary description for FrachtmittelRules.
    /// </summary>
    public partial class FrachtmittelRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public FrachtmittelRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((Frachtmittel) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        FrachtmittelEntity Entity = CurrentEntity as FrachtmittelEntity;
