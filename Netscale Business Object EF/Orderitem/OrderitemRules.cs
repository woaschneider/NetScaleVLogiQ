...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class OrderitemRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public OrderitemRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Orderitem)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						OrderitemEntity Entity = CurrentEntity as OrderitemEntity;
