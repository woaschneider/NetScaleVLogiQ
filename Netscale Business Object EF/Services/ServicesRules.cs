...
namespace HWB.NETSCALE.BOEF
{
	...
	/// </summary>
	public partial class ServicesRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ServicesRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Services)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						ServicesEntity Entity = CurrentEntity as ServicesEntity;
