...
{
    /// <summary>
    /// Summary description for UserProfilRules.
    /// </summary>
    public partial class UserProfilRules : ABusinessRule
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public UserProfilRules(ImmBusinessRuleHost hostObject) : base(hostObject)
        {
        ...
        public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
        {
            ...
            if (entityList != null)
            {
                foreach (EntityType CurrentEntity in entityList)
                {
                    ...
                    if (((UserProfil) this.HostObject).IsEntityChanged(this.CurrentEntity))
                    {
                        UserProfilEntity Entity = CurrentEntity as UserProfilEntity;
