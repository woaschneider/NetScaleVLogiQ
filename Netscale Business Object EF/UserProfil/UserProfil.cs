...
{
    /// <summary>
    /// Summary description for UserProfil.
    /// </summary>
    public partial class UserProfil : ABusinessObject<UserProfilEntity>
    {
        ...
        /// </summary>
        public override UserProfilEntity Entity
        {
            get
            {
        ...
        private UserProfilEntity _entity;

        /// <summary>
        /// Business Rule object
        /// </summary>
        public virtual UserProfilRules Rules
        {
            get { return (UserProfilRules) this.BusinessRuleObj; }
        ...
        public UserProfil()
        {
            ...
            this.TableName = "UserProfil";
            this.PhysicalDbcObjectName = "dbo.UserProfil";
            this.PrimaryKey = "PK";
        ...
        {
            return new UserProfilRules(this);
        }
