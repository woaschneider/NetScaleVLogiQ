...
{
	/// <summary>
	/// Summary description for MandantRules.
	/// </summary>
	public partial class MandantRules : ABusinessRule
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public MandantRules(ImmBusinessRuleHost hostObject) : base(hostObject)
		{
		...
		public override bool CheckRulesHook<EntityType>(mmBindingList<EntityType> entityList)
		{
			...
			if (entityList != null)
			{
				foreach (EntityType CurrentEntity in entityList)
				{
					...
					if (((Mandant)this.HostObject).IsEntityChanged(this.CurrentEntity))
					{
						MandantEntity Entity = CurrentEntity as MandantEntity;
